...
const PATHS = {
  // Navegação principal
  home: '<path d="M3 9.5 12 3l9 6.5V20a2 2 0 0 1-2 2h-4v-7h-6v7H5a2 2 0 0 1-2-2z"/>',
  dashboard: '<rect x="3" y="3" width="7" height="9" rx="1.5"/><rect x="14" y="3" width="7" height="5" rx="1.5"/><rect x="14" y="12" width="7" height="9" rx="1.5"/><rect x="3" y="16" width="7" height="5" rx="1.5"/>',
  swap: '<path d="M17 3 21 7l-4 4M21 7H7M7 21l-4-4 4-4M3 17h14"/>',
  arrows: '<path d="m7 16 4 4 4-4M11 4v16"/><path d="m17 8-4-4-4 4"/>',
...
const path = computed(() => PATHS[props.name] || PATHS['alert-circle'])
</script>
